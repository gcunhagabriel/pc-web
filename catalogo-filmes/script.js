  ...
  if (this.readyState == 4 && this.status == 200) {
    ...
    resposta.forEach((filme) => {
      ...
      switch (filme["classificacao"]) {
        case 18:
          classificacao.style.backgroundColor = "#222";
          break;
        case 16:
          classificacao.style.backgroundColor = "#f00";
          break;
        case 14:
          classificacao.style.backgroundColor = "#f80";
          break;
        case 12:
          classificacao.style.backgroundColor = "#fd0";
          break;
        case 10:
          classificacao.style.backgroundColor = "#08f";
          break;
        default:
          classificacao.style.backgroundColor = "#080";
...
const objetoXMLHttpRequest = new XMLHttpRequest();
objetoXMLHttpRequest.open("GET", url);
objetoXMLHttpRequest.send();
objetoXMLHttpRequest.onreadystatechange = carregaFilmes;
